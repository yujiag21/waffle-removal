...
def experiment_training(env, agent, path_body: str, exp:str) -> None:
    ...
    if env.watermark_removal_ops.after_train_remove == 1:
        federated_model, scores = agent.after_train_watermark_remove(log_interval=10)
    elif env.federated_retrain == 1:
